...
function Page() {
  ...
  return (
    <AppShell
      title="Lagos regional valuation Q3 2024"
    ...
    >
      ...
      <div className="mt-6 surface-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
          Property values in Lagos State rose 6.4% year-over-year, driven primarily by Lekki Phase
          1, Victoria Island, and the Ibeju-Lekki corridor. Verification throughput improved by 18%
          as more surveyors onboarded, and disputed parcels fell to 1.2% of the active inventory —
          the lowest since Q1 2022.
        </p>
