    ...
    >
      ...
      <KpiRow
        items={[
          ...
          { label: "Median value", value: "₹1.84 Cr", hint: "+6.4% YoY" },
      ...
      <div className="mt-6 surface-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
          Property values in Bengaluru and surrounding urban corridors rose 6.4% year-over-year,
          driven primarily by Ramamurthy Nagar, Koramangala, and Whitefield. Verification throughput
          improved by 18% as more surveyors onboarded, and disputed parcels fell to 1.2% of the
          active inventory — the lowest since Q1 2022.
        </p>
        <h3 className="mt-6 font-display text-xl">Key findings</h3>
        <ul className="mt-2 list-disc space-y-1 pl-6 text-sm text-muted-foreground">
          <li>Ramamurthy Nagar median valuation: ₹3.12 Cr (up from ₹2.68 Cr)</li>
          <li>Boundary disputes concentrated in east Bengaluru (62% of regional total)</li>
          <li>
