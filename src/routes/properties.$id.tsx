      ...
      actions={
        <>
          <Button asChild className="rounded-full">
            <Link to="/properties/$id/verify" params={{ id: p.id }}><Workflow className="h-4 w-4" /> Run Verification</Link>
          </Button>
          ...
          <Tabs defaultValue="overview">
            ...
            <TabsContent value="documents" className="mt-4">
              <div className="surface-card divide-y divide-border">
                ...
                <Link to="/properties/$id/documents" params={{ id: p.id }} className="flex w-full items-center justify-center gap-2 p-4 text-sm text-primary hover:bg-muted/30">
                  + Upload document
                </Link>
              </div>
            </TabsContent>
        ...
        <aside className="flex flex-col gap-4">
          ...
          <div className="surface-card p-5">
            ...
            <div className="mt-3 flex gap-2">
              ...
              <Button size="sm" onClick={() => navigator.clipboard?.writeText(`https://terratrust.ai/p/${p.passportId}`)}>Copy</Button>
            </div>
          </div>
        </aside>
      </div>
