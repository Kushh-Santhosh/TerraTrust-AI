    ...
    <AppShell title="Bank origination" subtitle="Underwriting view of Property Passports shared with your institution.">
      ...
      <div className="mt-3">
        <DataTable rows={pipeline} columns={[
          ...
          { key: "p", label: "Parcel", render: r => <Link to="/properties/$id" params={{ id: r.parcel === "TT-8421-LG" ? "p_001" : r.parcel === "TT-5512-AB" ? "p_003" : "p_002" }} className="font-mono text-xs text-primary hover:underline">{r.parcel}</Link> },
