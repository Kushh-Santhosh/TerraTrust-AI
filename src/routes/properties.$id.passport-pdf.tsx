...
function PassportPDF() {
  ...
  const passportIssued = p.status === "verified";
    ...
    <div className="min-h-screen bg-muted/30 print:bg-white">
      ...
      <main className="mx-auto my-8 max-w-[820px] bg-white text-[#0a1224] shadow-[var(--shadow-elev)] print:my-0 print:shadow-none">
          ...
          <div className="relative flex items-start justify-between gap-6">
            <div>
              ...
              <p className="mt-1 text-sm text-white/70">
                {passportIssued ? "Machine-verifiable certificate of registered tenure — issued via TerraTrust AI." : "Property verification record — passport issuance pending review."}
              </p>
            </div>
        ...
        <div className="grid grid-cols-[1fr_220px] gap-10 px-10 py-8">
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-lg border border-[#0a1224]/10 p-4">
              ...
              {passportIssued ? (
                <>
                  <p className="mt-1 font-mono text-[11px] leading-tight text-[#0a1224]">ed25519:{signatureHash}…</p>
                  <p className="mt-2 text-[10px] text-[#0a1224]/60">Signed by the issuing bureau on {issuedOn}. Any modification invalidates this passport.</p>
                </>
              ) : (
                <p className="mt-1 text-[11px] text-[#0a1224]/60">Not issued. This passport is held pending human verification.</p>
              )}
            </div>
        ...
        <div className="border-t border-[#0a1224]/10 bg-[#f8fafc] px-10 py-5 text-[11px] text-[#0a1224]/60">
          <p>
            {passportIssued ? "This document is a court-admissible representation of the digital Property Passport." : "This document is a preview of the Property Passport record and is not an issued certificate."}
            For real-time status, scan the QR code or visit terratrust.ai/p/{p.passportId}.
            {passportIssued ? ` Issued under the authority of the National Land Authority via TerraTrust AI · Doc ref ${p.passportId}-${signatureHash.slice(0,4)}.` : " Issuance requires completion of the verification workflow and human review."}
          </p>
        </div>
      </main>
